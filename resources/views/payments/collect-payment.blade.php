<x-app-layout>
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            <h1 class="h2 fw-bold mb-1" style="color: #1f2937;">Collect Payment</h1>
            <p class="text-muted mb-0">Collect payment from an approved contract or proforma invoice</p>
        </div>
    ...
    <div x-data="{
        ...
        selectContract(contractId) {
            ...
            window.location.href = '{{ route('payments.collect-payment') }}?contract_id=' + contractId + '&sales_manager=' + this.selectedSalesManager;
        },
        ...
        selectProformaInvoice(piId) {
            ...
            window.location.href = '{{ route('payments.collect-payment') }}?proforma_invoice_id=' + piId + '&sales_manager=' + this.selectedSalesManager;
        },
        ...
        <div class="card shadow-sm border-0 mb-4" style="background: linear-gradient(to bottom, #ffffff 0%, color-mix(in srgb, var(--primary-color) 6%, #ffffff) 100%); border-radius: 12px;">
            ...
            <div class="card-body p-4">
                <form method="GET" action="{{ route('payments.collect-payment') }}" id="searchForm">
                    <div class="row g-3">
                        <div class="col-md-4">
        ...
        <div class="card shadow-sm border-0" style="background: linear-gradient(to bottom, #ffffff 0%, color-mix(in srgb, var(--primary-color) 6%, #ffffff) 100%); border-radius: 12px;">
            <div class="card-header border-0 pb-0" style="background: transparent;">
                <div class="d-flex align-items-center py-3 border-bottom" style="border-color: color-mix(in srgb, var(--primary-color) 20%, transparent) !important;">
                    ...
                    <h2 class="h5 fw-bold mb-0" style="color: #1f2937;">Collect Payment Details</h2>
                </div>
            </div>
            <div class="card-body p-4">
