                    ...
                    <div class="table-responsive" style="max-height: calc(100vh - 350px); overflow-y: auto;">
                        <table class="table table-hover mb-0 align-middle">
                            <thead class="sticky-top" style="background: linear-gradient(to right, #f3e8ff, #e9d5ff) !important;">
                                <tr>
                                    <th class="px-4 py-3 text-uppercase small fw-bold" style="color: #4c1d95 !important;">City Name</th>
                            ...
                            <tbody>
                                @forelse($cities as $city)
                                    <tr class="border-bottom">
                                        ...
                                        <td class="px-4 py-3">
                                            <span class="badge bg-purple-100 text-purple-800">{{ $city->state->name }}</span>
                                        </td>
                                        <td class="px-4 py-3">
