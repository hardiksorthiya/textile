    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            ...
            <div class="h-64 flex items-end justify-between space-x-2">
                ...
                <div class="flex-1 flex flex-col items-center">
                    <div class="w-full bg-purple-500 rounded-t" style="height: 80%"></div>
                ...
                <div class="flex-1 flex flex-col items-center">
                    <div class="w-full bg-purple-500 rounded-t" style="height: 70%"></div>
                ...
                <div class="flex-1 flex flex-col items-center">
                    <div class="w-full bg-purple-500 rounded-t" style="height: 55%"></div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('users.index') }}" class="text-sm text-purple-600 hover:text-purple-700">View All</a>
            </div>
            <div class="space-y-4">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            ...
            <div class="text-center mb-4">
                <p class="text-4xl font-bold text-purple-600 mb-1">{{ \App\Models\User::whereMonth('created_at', now()->month)->count() }}</p>
            ...
            <div class="h-32 flex items-end justify-between space-x-1">
                ...
                <div class="flex-1 bg-purple-500 rounded-t" style="height: 70%"></div>
            </div>
