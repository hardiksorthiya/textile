<x-app-layout> 
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            <h1 class="h2 fw-bold mb-1" style="color: #1f2937;">Machine E-Read Management</h1>
            <p class="text-muted mb-0">Manage Machine E-Reads and their related categories</p>
        </div>
    </div>
            ...
            <div class="card shadow-sm border-0 h-100" style="background: linear-gradient(to bottom, #ffffff 0%, #faf5ff 100%); border-radius: 12px;">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-4 pb-3 border-bottom" style="border-color: rgba(139, 92, 246, 0.2) !important;">
                        ...
                        <h2 class="h5 fw-bold mb-0" style="color: #1f2937;" x-text="isEditing ? 'Edit Machine E-Read' : 'Add Machine E-Read'"></h2>
                    </div>
                    ...
                    <div x-show="!isEditing">
                        <form action="{{ route('machine-e-reads.store') }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary w-100 py-2 fw-semibold" style="border-radius: 8px; background: linear-gradient(45deg, #8b5cf6, #a78bfa) !important; border: none;">
                                <i class="fas fa-plus me-2"></i>Add Machine E-Read
                            </button>
                        </form>
                    </div>
            ...
            <div class="card shadow-sm border-0 h-100" style="background: linear-gradient(to bottom, #ffffff 0%, #faf5ff 100%); border-radius: 12px;">
                <div class="card-header border-0 pb-0" style="background: transparent;">
                    <div class="d-flex align-items-center py-3 border-bottom" style="border-color: rgba(139, 92, 246, 0.2) !important;">
                        ...
                        <h2 class="h5 fw-bold mb-0" style="color: #1f2937;">Machine E-Read List</h2>
                    </div>
                </div>
                                    ...
                                    <tr class="border-bottom" style="transition: all 0.2s ease;">
                                        <td class="px-4 py-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fw-semibold" style="color: #1f2937; font-size: 0.95rem;">{{ $eRead->name }}</div>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <small class="text-muted" style="font-size: 0.8rem;">{{ $eRead->created_at->format('M d, Y') }}</small>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="d-flex gap-2" role="group">
                                                ...
                                                <form action="{{ route('machine-e-reads.destroy', $eRead) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this Machine E-Read?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
                                                            class="btn btn-sm btn-outline-danger" 
                                                            title="Delete Machine E-Read"
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-center text-muted py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="mb-0" style="font-size: 0.9rem;">No Machine E-Reads found.</p>
                                                <small class="text-muted mt-1">Add your first Machine E-Read to get started</small>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
