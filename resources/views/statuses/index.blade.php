                    ...
                    <div class="table-responsive" style="max-height: calc(100vh - 350px); overflow-y: auto;">
                        <table class="table table-hover mb-0 align-middle">
                            <thead class="sticky-top" style="background: linear-gradient(to right, #f3e8ff, #e9d5ff) !important;">
                                <tr>
                                    <th class="px-4 py-3 text-uppercase small fw-bold" style="color: #4c1d95 !important;">Status Name</th>
                            ...
                            <tbody>
                                @forelse($statuses as $status)
                                    <tr class="border-bottom">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="d-flex gap-2">
                                                <button type="button" 
                                                        @click="editStatus({ id: {{ $status->id }}, name: '{{ addslashes($status->name) }}' })"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-5">No statuses found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
