                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="btn-group w-100" role="group">
                            <input type="radio" class="btn-check" name="lead_type" id="type_new" value="new" x-model="leadType" @change="switchFormType('new')">
                            <label class="btn btn-outline-primary" for="type_new" style="border-radius: 8px 0 0 8px;">
                                <i class="fas fa-plus-circle me-2"></i>New
                            </label>
                            <input type="radio" class="btn-check" name="lead_type" id="type_old" value="old" x-model="leadType" @change="switchFormType('old')">
