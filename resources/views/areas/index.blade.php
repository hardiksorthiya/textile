                ...
                <div class="card-body p-0">
                    <div class="table-responsive" style="max-height: calc(100vh - 350px); overflow-y: auto;">
                        <table class="table table-hover mb-0 align-middle">
                            <thead class="sticky-top" style="background: linear-gradient(to right, color-mix(in srgb, var(--primary-color) 10%, #ffffff), color-mix(in srgb, var(--primary-color) 18%, #ffffff)) !important;">
                                <tr>
                                    <th class="px-4 py-3 text-uppercase small fw-bold" style="color: var(--primary-dark) !important;">Area Name</th>
                                    <th class="px-4 py-3 text-uppercase small fw-bold" style="color: var(--primary-dark) !important;">City</th>
                                    <th class="px-4 py-3 text-uppercase small fw-bold" style="color: var(--primary-dark) !important;">State</th>
                                    <th class="px-4 py-3 text-uppercase small fw-bold" style="color: var(--primary-dark) !important;">Created</th>
                                    <th class="px-4 py-3 text-uppercase small fw-bold" style="color: var(--primary-dark) !important;">Actions</th>
                                </tr>
                            </thead>
                            <tbody>
