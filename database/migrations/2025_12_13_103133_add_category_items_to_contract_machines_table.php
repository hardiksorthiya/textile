...
return new class extends Migration
{
    ...
    public function down(): void
    {
        Schema::table('contract_machines', function (Blueprint $table) {
            ...
            $table->dropColumn([
                'feeder_id', 'machine_hook_id', 'machine_e_read_id', 'color_id',
                'machine_nozzle_id', 'machine_dropin_id', 'machine_beam_id',
                'machine_cloth_roller_id', 'machine_software_id', 'hsn_code_id',
                'wir_id', 'machine_shaft_id', 'machine_lever_id', 'machine_chain_id',
